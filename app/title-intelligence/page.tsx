        ...
        <section className="max-w-5xl mx-auto px-6 mt-20">
          ...
          <div data-tutorial="title-county" className="grid md:grid-cols-3 gap-6">
            {[
              ...
              { title: 'Intelligence Engines', desc: '5,486+ domain-specific AI engines including 22 landman engines for lease analysis, easements, water rights, and ROW acquisition.', href: '/engines', price: 'From $199/mo' },
