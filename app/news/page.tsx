...
export const metadata: Metadata = {
  title: 'News | Echo Prime Technology',
  description: 'News is a powerful AI-powered solution built on the Echo Prime Technology platform.',
}
      ...
      <section className="relative py-24 px-4 overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto text-center relative z-10">
          ...
          <p className="text-xl text-gray-400 max-w-3xl mx-auto mb-8">
            News is a powerful AI-powered solution built on the Echo Prime Technology platform.
          </p>
