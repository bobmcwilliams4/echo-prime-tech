...
export const metadata: Metadata = {
  ...
  description: 'Warm, empathetic AI assistant with voice conversations, 14 personality modes, and deep knowledge across 210 domains. Your personal AI companion.',
