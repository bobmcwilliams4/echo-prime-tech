      ...
      <div className="max-w-[1400px] mx-auto flex">
        ...
        <main ref={mainRef} className="flex-1 min-w-0 px-4 md:px-10 py-10 md:py-12">
          ...
          <div className="mb-12">
            ...
            <p className="text-zinc-400 text-base mb-4 max-w-2xl">Complete reference for the Echo Prime SDK Gateway. Access 2,600+ intelligence engines, 75K+ knowledge chunks, semantic memory, doctrine generation, and multi-personality AI chat through a single unified API.</p>
