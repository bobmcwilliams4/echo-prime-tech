...
const CODE_EXAMPLES: Record<string, string> = {
  typescript: `import EchoPrime from "@echo-prime/sdk";
...
export default function SDKDeveloperPortal() {
  ...
  const [engineCount, setEngineCount] = useState('6,500+');
  const [doctrineCount, setDoctrineCount] = useState('619K+');
          ...
          {[
            {
              step: '1',
              title: 'Install',
              code: 'npm install @echo-prime/sdk',
            ...
            },
            {
              ...
              description: 'Query any of 6,500+ engines from the command line or SDK.',
            },
          ].map(s => (
