...
export const metadata: Metadata = {
  ...
  description: 'Engine-backed AI intelligence across 210 domains. Tax, legal, cybersecurity, oilfield, finance, engineering, and more. Doctrine-grounded answers with authority citations.',
  ...
  openGraph: {
    ...
    description: 'Engine-backed AI across 210 domains with authority citations. Tax, legal, cyber, oilfield, finance.',
