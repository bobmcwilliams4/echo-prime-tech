...
const ENGINE_FAQS = [
  ...
  { q: 'How many engines are available?', a: 'Over 5,500 engines across 40+ domains including Tax Intelligence, Legal Analysis, Drilling Engineering, Cybersecurity, Medical Intelligence, Mechanical Engineering, and more. New engines are continuously added via the Doctrine Forge.' },
  { q: 'What is a doctrine?', a: 'A doctrine is a verified, authoritative knowledge unit — a specific rule, regulation, standard, or precedent extracted from primary sources. Each engine contains hundreds to thousands of doctrines that form its knowledge base. Over 630,000 doctrines are currently indexed.' },
  { q: 'How accurate are engine responses?', a: 'Engine responses are grounded in real authority citations — IRC sections, case law, NIST frameworks, API standards, etc. The TIE Gold Standard requires every doctrine to include source references, confidence levels, and adversary positions. Our 100-question test battery achieved 99% GOLD pass rate.' },
  { q: 'Can I build custom engines?', a: 'Yes. Enterprise plans include custom engine creation. You provide the domain knowledge and authoritative sources, and we build a dedicated engine with full doctrine coverage. Custom engines integrate seamlessly with the existing engine ecosystem.' },
  { q: 'What is the pricing model?', a: 'Engines are priced per query in four tiers: Supreme ($12-$30/query for Tax, Legal, Medical), Critical ($9-$24 for Drilling, Energy), Engineering ($6-$18 for Mechanical, Automotive), and Standard ($2.50-$15 for AI/ML, Business). Volume discounts available on Professional and Enterprise plans.' },
];
...
export default function EnginesPage() {
  ...
  "name": "Echo Intelligence Engines",
  "description": "5,500+ domain-specific AI engines with 630,000+ doctrines covering Tax, Legal, Engineering, Medical, Cybersecurity, and 40+ other domains. Court-defensible, citation-backed AI intelligence.",
