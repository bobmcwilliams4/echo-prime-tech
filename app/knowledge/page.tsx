        ...
        <>
          ...
          <section className="max-w-4xl mx-auto px-6 pb-16">
            <div className="p-8 rounded-2xl border" style={{ backgroundColor: 'var(--ept-card-bg)', borderColor: 'var(--ept-card-border)' }}>
              ...
              <p className="text-sm mb-6" style={{ color: 'var(--ept-text-muted)' }}>Search across all 940+ knowledge domains, 5,486+ engines, and 601K+ pre-compiled doctrines. Select a domain or search globally.</p>
              <EngineQueryPanel
