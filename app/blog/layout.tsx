...
export const metadata: Metadata = {
  ...
  description: '100 technical deep-dives on AI engineering, oilfield technology, tax intelligence, cybersecurity, and building autonomous systems at scale. Written by the team that builds 5,486+ intelligence engines.',
  openGraph: {
