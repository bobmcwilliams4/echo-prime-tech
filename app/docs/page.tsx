...
const categories: DocCategory[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Analytics Engine', href: '/docs/analytics-engine', badge: 'Docs' },
      { name: 'Analytics Dashboard', href: '/docs/analytics', badge: 'Docs' },
      { name: 'AI Orchestrator', href: '/docs/orchestration', badge: 'Docs' },
      { name: 'Model Host', href: '/docs/model-host', badge: 'Docs' },
      { name: 'Chat AI', href: '/docs/chat-ai', badge: 'Docs' },
      { name: 'Mega Gateway', href: '/docs/mega-gateway', badge: 'Docs' },
      { name: 'Agentic Engine', href: '/docs/agentic-engine', badge: 'Docs' },
      { name: 'App Forge', href: '/docs/app-forge', badge: 'Docs' },
      { name: 'Prompt Forge', href: '/docs/prompt-forge', badge: 'Docs' },
    ],
  },
  {
    ...
    items: [
      ...
      { name: 'Invoicing', href: '/docs/invoicing', badge: 'Docs' },
      { name: 'Office AI', href: '/docs/office-ai', badge: 'Docs' },
      { name: 'Booking', href: '/docs/booking', badge: 'Docs' },
      { name: 'Expense Tracking', href: '/docs/expense-management', badge: 'Docs' },
      { name: 'Finance AI', href: '/docs/finance-ai', badge: 'Docs' },
      { name: 'HR Management', href: '/docs/hr-management', badge: 'Docs' },
      { name: 'Project Management', href: '/docs/project-management', badge: 'Docs' },
      { name: 'Appointments', href: '/docs/appointments', badge: 'Docs' },
      { name: 'Asset Manager', href: '/docs/asset-manager', badge: 'Docs' },
      { name: 'Customer Success', href: '/docs/customer-success', badge: 'Docs' },
      { name: 'Finance', href: '/docs/finance', badge: 'Docs' },
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'SEC Intelligence', href: '/docs/sec-intel', badge: 'Docs' },
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Domain Harvester', href: '/docs/domain-harvester', badge: 'Docs' },
      { name: 'Drive Intelligence', href: '/docs/drive-intelligence', badge: 'Docs' },
      { name: 'Feature Flags', href: '/docs/feature-flags', badge: 'Docs' },
      { name: 'Data Pipeline', href: '/docs/pipelines', badge: 'Docs' },
      { name: 'Workflows', href: '/docs/workflows', badge: 'Docs' },
      { name: 'Website Builder', href: '/docs/websites', badge: 'Docs' },
    ],
  },
  {
    ...
    items: [
      ...
      { name: 'Scrapers', href: '/docs/scrapers', badge: 'Docs' },
      { name: 'Report Generator', href: '/docs/report-generator', badge: 'Docs' },
      { name: 'Diagnostics', href: '/docs/diagnostics', badge: 'Docs' },
      { name: 'Document Delivery', href: '/docs/document-delivery', badge: 'Docs' },
      { name: 'News Intelligence', href: '/docs/news', badge: 'Docs' },
    ],
  },
  {
    ...
    items: [
      ...
      { name: 'Rewards / Echo Coin', href: '/docs/rewards', badge: 'Docs' },
      { name: 'eBay AI', href: '/docs/ebay-ai', badge: 'Docs' },
      { name: 'Crypto Trading', href: '/docs/crypto-trading', badge: 'Docs' },
      { name: 'Data Room', href: '/docs/data-room', badge: 'Docs' },
      { name: 'E-Commerce', href: '/docs/ecommerce', badge: 'Docs' },
      { name: 'Shopify Integration', href: '/docs/shopify', badge: 'Docs' },
      { name: 'Runway Creative', href: '/docs/runway', badge: 'Docs' },
    ],
  },
]
