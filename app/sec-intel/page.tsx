      ...
      <section className="max-w-5xl mx-auto px-6 pb-16">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {[
            ...
            { title: 'Intelligence Engines', desc: '5,486+ domain-specific AI engines with embedded expertise across 940+ verticals including finance and accounting.', href: '/engines', price: 'From $199/mo' },
          ].map((svc, i) => (
